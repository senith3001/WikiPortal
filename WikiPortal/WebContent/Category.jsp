...
<c:forEach var="category" items="${listCategory}">
				...
				<li><a href="${pageContext.request.contextPath}/WikiPortalServlet?action=articlesByCategory&categoryID=<c:out value='${category.getCategoryID()}' />"><c:out value="${category.getName()}" /></a></li><br>
